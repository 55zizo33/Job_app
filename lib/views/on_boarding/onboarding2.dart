...
import 'package:jobs_app/views/on_boarding/onboarding3.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 24),
                Center(
                  child: Image.asset('assets/images/Tittle (2).png'),
                ),
                SizedBox(height: 20),
                RichText(
                  text: TextSpan(
                ...
                Center(
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const OnboardingView3()),
                      );
                    },
