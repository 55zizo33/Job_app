...
class ApplyJob7View extends StatefulWidget {
  ...
  @override
  _ApplyJob7ViewState createState() => _ApplyJob7ViewState();
}

class _ApplyJob7ViewState extends State<ApplyJob7View> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => AppliedJob6()),
            );
          },
        ),
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // إضافة الجزء الخاص بالصورة والمعلومات الوظيفية هنا
              Center(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Image.asset(
                      'assets/images/Invision Logo.png', // تأكد من وجود الصورة في المسار الصحيح
                      width: 48,
                      height: 48,
                    ),
                    SizedBox(height: 16),
